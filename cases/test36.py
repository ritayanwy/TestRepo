...
TEST = {
    'name': 'PreferenceAPI set level 3 get match check',
    'request': [
                    {   'method': 'POST',
                        'url': '/k/v6/preference/set',
                        'data': {
                            'changes':'[{"change":{"account":{"13":{"notifiable_folder":[{"notification_sound":3},{"label":"Parent folder","mailbox_path":"[Gmail]/All Mail"}]}}},"type":"set"}]'
                        }
                    },
                    {   'method': 'POST',
